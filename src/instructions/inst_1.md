# Hello!
Welcome to this **decision-making task**! In this task, you will engage in a **space shooter game** where your goal is to **maximize your total score** by making strategic decisions. This task length is approximately **1 hour**, including instructions and short surveys at the end. Please **read** the instructions **carefully** before starting.

# Task Overview

* **Structure** - There will be **5 game phases** (game 1, 2, 3, 4, 5) of respectively \~3min, \~3min, \~3min, \~10min, and \~10min. You will also encounter **four short surveys** at the end (\~16min total). You can track your progress at anytime with the **timeline** displayed at the top of this webpage.
