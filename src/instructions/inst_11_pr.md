...
Now let's continue with **game 5**. Game 5 consists in the exact same task as game 4, but with a **twist**: unlike the previous game, when a shield deflects you will now receive **0 points** instead of half. Again maximize your overall score! You can reasonably expect a score of at least **~40000 points**. This phase lasts around ~10min. <br><br>
...
admonition=<div class="admonition notice" style="">
	  ...
	  This time, you receive 0 points when a shield deflects (instead of half)
	  </p>
		</div>
<br>
